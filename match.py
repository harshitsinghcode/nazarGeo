...
#     # FIXED: accept either key name from perceive.py
...
def _score(dist_m, angle_off, footprint_w_m, detected_img_frac, depth_m):
    ...
    return angle_score + prox_score + width_score + depth_bonus, angle_score, prox_score, width_score, depth_bonus
